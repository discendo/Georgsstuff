...
if(isset ($_GET['Loeschen'])) 
  {
      ...
      $stmt = $pdo->prepare("TRUNCATE TABLE gruppenuser");
        $stmt->execute();
...
<header><h1>Gruppeneinteilung</h1></header>
<nav>
...
Nach dem Absenden kann die Gruppe noch geändert werden, bzw neue Personen hinzugefügt werden!	
	<p class="f">Gruppe:
		...
		<input type="hidden" id ="arbeitsname" name="arbeitsname"  value="LGS">
			...
			<button name = 'Loeschen'>Löschen!</button>
			
		</p>
	</form>
	
	<form action="GAarbeitsphase.php" method = "GET">
		  
	    </p>		
	    	<button>Arbeitsphase</button>
		</p>

</form>
<p>Bitte scannen: </p>
<img src="Bilder\QR.png" >
</nav>
