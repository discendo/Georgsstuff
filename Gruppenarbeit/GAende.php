...
<h1>Gruppenarbeit</h1>
<h1>Präsentation. Besprecht bitte, wer was vorstellt</h1>
<form action="GAstart.php" method = "GET">
	    </p>		
	    	<button name = 'Button'>Zum Anfang</button>
...
<form action="GAarbeitsphase.php" method = "POST">
		  
	    </p>		
	    	<button name = 'Button'>Zurück</button>
		</p>
